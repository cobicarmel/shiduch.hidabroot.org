...
$fields = [
	...
	[
		...
		'choices' => Male::$props['college_type']['options'],
		'default_value' => '',
		'layout' => 'vertical',
	],
	[
		'key' => 'field_559b5cd4320ce',
		'label' => 'סוג סמינר',
		'name' => 'college_type',
		'type' => 'checkbox',
		'conditional_logic' => [
		...
		'choices' => Female::$props['college_type']['options'],
		'default_value' => '',
		'layout' => 'vertical',
	],
	[
...
foreach(Cards::getTerms() as $term) {
